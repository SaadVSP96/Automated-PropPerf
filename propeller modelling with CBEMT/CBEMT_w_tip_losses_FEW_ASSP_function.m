...
function [theta_rad,phi_rad,C_l,C_d,Lambda,sigma]...
= CBEMT_w_tip_losses_FEW_ASSP_function(r_by_R, c_ft, theta_deg, C_l_a_per_rad, R_ft, Omega_R_fts, V_fts, N_b)
%Defining the constant values
V_forward = V_fts;%forward velocity
