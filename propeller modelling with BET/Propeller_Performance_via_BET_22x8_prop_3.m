...
%Basic Data
V_0_fts = 10*1.688;%mph to ft/s
RPM = 4000;
Dia_prop = 11.01*2*1.5;%inches
Dia_hub = 3.13*2*1.5;%inches
alt_op = 1;% n*1000 ft
a_alt = a(alt_op);
...
for i = 1:1:no_elements
    ...
    d_Q(i) = ((d_L(i)*sin(phi_rad(i)+alpha_i_rad(i)))+(d_D(i)*cos...
             (phi_rad(i)+alpha_i_rad(i))));
    d_P(i) = ((d_L(i)*sin(phi_rad(i)+alpha_i_rad(i)))+...
