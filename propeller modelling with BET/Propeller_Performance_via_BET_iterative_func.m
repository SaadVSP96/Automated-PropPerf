...
function [eeta_p]=Propeller_Performance_via_BET_iterative_func...
                  (velocity_fts, RPM, altitude)
...
%Basic Data
V_0_fts = velocity_fts*1.68781;%ft/s
Dia_prop = 34;%inches
Dia_hub = 4;%inches
...
for i = 1:1:no_elements
    Beta_rad(i) = deg2rad(50*(1-((i-R_hub)/no_elements))+(10*((i-R_hub)/no_elements)));
    for j = 1:1:40
